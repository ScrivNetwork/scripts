# Thanks to Zoldur for good scripts he is creating.
# Forked from https://github.com/zoldur/Manocoin/blob/master/mano_install.sh
# SCRIV Masternode Auto-Installer v.1.0
...
libminiupnpc-dev libgmp3-dev ufw pkg-config libevent-dev autoconf-archive unzip >/dev/null 2>&1
if [ "$?" -gt "0" ];
  then
...
bsdmainutils libdb4.8++-dev libminiupnpc-dev libgmp3-dev ufw pkg-config libevent-dev autoconf-archive"
 exit 1
fi
clear
}
...
function important_information() {
 ...
 echo -e "================================================================================================================================"
 echo -e "AND DON'T FORGET: 1 SCRIV = 1 USD ;)"
 echo -e "================================================================================================================================"
}
